...
DELIMITER //
CREATE TRIGGER bic_uso AFTER INSERT ON DESPLAZAMIENTOS FOR EACH ROW
BEGIN
...
DELIMITER //
CREATE TRIGGER bic_est AFTER UPDATE ON DESPLAZAMIENTOS FOR EACH ROW
BEGIN
...
DELIMITER //
CREATE TRIGGER bic_taller AFTER INSERT ON MANTENIMIENTO FOR EACH ROW
BEGIN
